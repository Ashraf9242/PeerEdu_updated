...
const translations = {
  en: {
    ...
    "register.placeholder.uploadId": "Upload your student ID or any document proving you are an active student",
  ...
  ar: {
    ...
    "register.placeholder.uploadId": "ارفع هوية الطالب أو أي وثيقة تثبت أنك طالب نشط",
