...
const translations = {
  en: {
    ...
    "dashboard.teacher.photoHelper": "????? ??? ?????? ?? ????? ?????? ??? ?????? ???? ???????.",
    "dashboard.teacher.photoAlt": "???? ??????",
    ...
    "dashboard.teacher.subjectVerification.identity": "???? ?? ???? ?????? ???? ?????? ???? ?????? ?????? ?? ??????? ???????.",
    "dashboard.teacher.subjectVerification.grade": "???? ?? ?????? ???????? ????? ?????? ?? ?????.",
    "dashboard.teacher.subjectVerification.helper": "???? ?? ?? ??????? ???? ??? ????? ????? ??????????.",
    "dashboard.teacher.subjectVerification.error": "???? ????? ???????? ??? ????? ??????.",
    "dashboard.teacher.gradeProof": "???? ????? ??????",
    "dashboard.teacher.gradeProof.helper": "???? ??? PDF ?? ???? ????? ???? ???? ??? ?????? (PDF/JPG/PNG ??? ???? 10 ????????).",
    "dashboard.teacher.gradeProof.selected": "????? ??????",
    "dashboard.teacher.gradeProof.error": "???? ??? ????? ??????? ??? ????? ??? ??????.",
    "dashboard.teacher.availabilityTitle": "?????? ????????",
    "dashboard.teacher.availabilityHelper": "??? ??????? ???? ???? ?????? ????? ???.",
