...
const translations = {
  en: {
    ...
    "dashboard.student.hero.spotlightTitle": "Learning spotlight",
    ...
    "dashboard.student.hero.spotlightSavingsNote": "Savings estimate based on completed sessions.",
    ...
    "dashboard.student.stats.savings": "Estimated Savings",
  ...
  ar: {
    ...
    "dashboard.student.hero.spotlightTitle": "أضواء التعلم",
    ...
    "dashboard.student.hero.spotlightSavingsNote": "تقدير التوفير بناءً على الجلسات المكتملة.",
    ...
    "dashboard.student.stats.savings": "التوفيرات المقدرة",
    ...
    "register.university.utas.ibri": "يوتاس عبري",
    ...
    "register.university.utas.general": "????? ??????? ??????? ????????? (????????)",
    "register.university.utas.shinas": "????? ??????? ??????? ????????? ????",
    "register.university.utas.sur": "????? ??????? ??????? ????????? ???",
    "register.university.utas.almusannah": "????? ??????? ??????? ????????? ???????",
    "register.university.utas.ibra": "????? ??????? ??????? ????????? ?????",
    "register.university.utas.rustaq": "????? ??????? ??????? ????????? ???????",
    "register.university.buraimi": "????? ???????",
    "register.university.sohar": "????? ????",
    "register.university.asharqiyah": "????? ???????",
    "register.university.national": "??????? ??????? ?????? ????????????",
    "register.university.majan": "???? ???? ????????",
    "register.university.modern": "?????? ??????? ??????? ???????",
    "register.university.middleeast": "???? ????? ??????",
    "register.university.arabopen": "??????? ??????? ???????? - ????",
    "register.university.tourism": "???? ???? ???????",
    "register.university.healthsciences": "???? ???? ?????? ??????",
    "register.university.maritime": "?????? ??????? ??????? ????",
    "register.university.dental": "???? ???? ??? ???????",
    "register.university.alzahra": "???? ??????? ??????",
    "register.university.gulf": "???? ??????",
    "register.university.bayan": "???? ??????",
    "register.university.law": "???? ???? ???????",
