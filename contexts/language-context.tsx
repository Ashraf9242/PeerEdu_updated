...
const translations = {
  en: {
    ...
    "dashboard.teacher.prefixHelper": "Pick the title (Mr./Ms./Dr.) that should display beside your name.",
  ...
  ar: {
    ...
    "dashboard.teacher.prefixHelper": "اختر اللقب (السيد/السيدة/د.) الذي سيظهر بجانب اسمك.",
